...
public class AI_NameListAttack : MonoBehaviour
{
    ...
    public void EnemyAIProbSet(EnemyStatus.AI_Level ai_Level)
    {
        switch (ai_Level)
        {
            case EnemyStatus.AI_Level.Level1:
                ...
                apprProbs.Add((int)AI_Approach.Normal, 90.0f);
                apprProbs.Add((int)AI_Approach.HighSpeed, 10.0f);

                waitProbs.Add((int)AI_Wait.Normal, 100.0f);

                atkProbs.Add((int)AI_Attack.Normal, 70.0f);
                atkProbs.Add((int)AI_Attack.Scatter, 20.0f);

                escProbs.Add((int)AI_Escape.Normal, 100.0f); ;
                break;
    ...
    void AIProbInitLevel2()
    {
        ...
        apprProbs.Add((int)AI_Approach.Normal, 70.0f);
        apprProbs.Add((int)AI_Approach.HighSpeed, 30.0f);

        waitProbs.Add((int)AI_Wait.Normal, 100.0f);

        atkProbs.Add((int)AI_Attack.Normal, 60.0f);
        atkProbs.Add((int)AI_Attack.Scatter, 30.0f);
        atkProbs.Add((int)AI_Attack.Fireworks, 10.0f);
    ...
    void AIProbInitLevel3()
    {
        ...
        apprProbs.Add((int)AI_Approach.Normal, 50.0f);
        apprProbs.Add((int)AI_Approach.HighSpeed, 50.0f);

        waitProbs.Add((int)AI_Wait.Normal, 100.0f);

        atkProbs.Add((int)AI_Attack.Normal, 50.0f);
        atkProbs.Add((int)AI_Attack.Scatter, 30.0f);
        atkProbs.Add((int)AI_Attack.Fireworks, 15.0f);
        atkProbs.Add((int)AI_Attack.Booster, 5.0f);
