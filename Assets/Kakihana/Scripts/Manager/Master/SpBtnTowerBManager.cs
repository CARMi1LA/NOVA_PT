    ...
    void Start()
    {
        ...
        NextLv.Subscribe(_ =>
        {
            switch (_)
            {
                case ShopData.TowerBlue_ParamList.Param_Trap:
                    ...
                    nextLvTrap = ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Trap.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Param_Turret:
                    nextLvTurret = ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Turret.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Param_Tower:
                    nextLvTower = ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Tower.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Repair:
                    nextLvRepair = ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Repair.Value + 1;
        ...
        InitSubject.Subscribe(_ =>
        {
            ...
            spBtn[0].levelText.text =
                ...
                ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Trap.Value,
                nextLvTrap);

            spBtn[1].levelText.text =
                string.Format("Lv{0}→Lv{1}",
                ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Turret.Value,
                nextLvTurret);

            spBtn[2].levelText.text =
                string.Format("Lv{0}→Lv{1}",
                ShopManager.Instance.spLv.towerLv[(int)ShopData.TowerColor.Blue].level_Tower.Value,
                nextLvTower);
