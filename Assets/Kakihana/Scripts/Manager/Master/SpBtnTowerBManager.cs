...
public class SpBtnTowerBManager : MonoBehaviour
{
    ...
    private ShopData.TowerBlue_ParamList param;
    ...
    // レベル更新イベント
    public Subject<ShopData.TowerBlue_ParamList> ChangeLvText = new Subject<ShopData.TowerBlue_ParamList>();
    // 必要金額更新イベント
    public Subject<ShopData.TowerBlue_ParamList> ChangeValueText = new Subject<ShopData.TowerBlue_ParamList>();
    // 購入可能時のイベント
    public Subject<ShopData.TowerBlue_ParamList> BuyOkText = new Subject<ShopData.TowerBlue_ParamList>();
    // 購入不可能時のイベント
    public Subject<ShopData.TowerBlue_ParamList> BuyNgText = new Subject<ShopData.TowerBlue_ParamList>();
    // レベル最大時のイベント
    public Subject<ShopData.TowerBlue_ParamList> SoldOutText = new Subject<ShopData.TowerBlue_ParamList>();
    // 次レベル設定イベント
    public Subject<ShopData.TowerBlue_ParamList> NextLv = new Subject<ShopData.TowerBlue_ParamList>();
    ...
    private void Awake()
    {
        ...
        InitSubject.Subscribe(_ =>
        {
            ...
            // 次のレベルを設定
            NextLv.OnNext(ShopData.TowerBlue_ParamList.Param_Trap);
            NextLv.OnNext(ShopData.TowerBlue_ParamList.Param_Turret);
            NextLv.OnNext(ShopData.TowerBlue_ParamList.Param_Tower);
            NextLv.OnNext(ShopData.TowerBlue_ParamList.Repair);

            // 強化内容テキストを設定
            spBtn[0].levelText.text =
                string.Format("Lv{0}→Lv{1}",
                ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Trap.Value,
                nextLvTrap);

            spBtn[1].levelText.text =
                string.Format("Lv{0}→Lv{1}",
                ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Turret.Value,
                nextLvTurret);

            spBtn[2].levelText.text =
                string.Format("Lv{0}→Lv{1}",
                ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Tower.Value,
                nextLvTower);
            ...
            spBtn[0].materValueText.text =
                ...
                blueData_Tower[nextLvTrap].purchaseMater);

            spBtn[1].materValueText.text =
                string.Format("{0}",
                ShopManager.Instance.shopData.
                blueData_Tower[nextLvTurret].purchaseMater);


            spBtn[2].materValueText.text =
                string.Format("{0}",
                ShopManager.Instance.shopData.
                blueData_Tower[nextLvTower].purchaseMater);
    ...
    void Start()
    {
        ...
        NextLv.Subscribe(_ =>
        {
            switch (_)
            {
                case ShopData.TowerBlue_ParamList.Param_Trap:
                    ...
                    nextLvTrap = ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Trap.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Param_Turret:
                    nextLvTurret = ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Turret.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Param_Tower:
                    nextLvTower = ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Tower.Value + 1;
                    break;
                case ShopData.TowerBlue_ParamList.Repair:
                    nextLvRepair = ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue].level_Repair.Value + 1;
                    nextRepairVal = (ShopManager.Instance.shopData.blueData_Tower[nextLvRepair].purchaseMater * 5);
                    break;
                default:
                    break;
            }
        ...
        InitSubject.OnNext(ShopManager.Instance.spLv.towerLv[(int)MasterData.TowerColor.Blue]);
        ...
        SoldOutText.Subscribe(list =>
        {
            switch (list)
            {
                ...
                case ShopData.TowerBlue_ParamList.Repair:
                    ...
                    spBtn[3].levelText.text = string.Format("Max RepaiBlue...");
                    spBtn[3].materValueText.color = Color.red;
                    spBtn[3].myBtn.interactable = false;
                    break;
                default:
