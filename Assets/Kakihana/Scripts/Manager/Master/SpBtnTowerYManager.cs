...
public class SpBtnTowerYManager : MonoBehaviour
{
    ...
    // レベル更新イベント
    public Subject<ShopData.TowerYellow_ParamList> ChangeLvText = new Subject<ShopData.TowerYellow_ParamList>();
    // 必要金額更新イベント
    public Subject<ShopData.TowerYellow_ParamList> ChangeValueText = new Subject<ShopData.TowerYellow_ParamList>();
    // 購入可能時のイベント
    public Subject<ShopData.TowerYellow_ParamList> BuyOkText = new Subject<ShopData.TowerYellow_ParamList>();
    // 購入不可能時のイベント
    public Subject<ShopData.TowerYellow_ParamList> BuyNgText = new Subject<ShopData.TowerYellow_ParamList>();
    // レベル最大時のイベント
    ...
    void Start()
    {
        ...
        InitSubject.Subscribe(_ =>
        {
            ...
            // 次のレベルを設定
            NextLv.OnNext(ShopData.TowerYellow_ParamList.Param_Trap);
            NextLv.OnNext(ShopData.TowerYellow_ParamList.Param_Turret);
            NextLv.OnNext(ShopData.TowerYellow_ParamList.Param_Tower);
            NextLv.OnNext(ShopData.TowerYellow_ParamList.Repair);
            ...
            spBtn[0].materValueText.text =
                ...
                yellowData_Tower[nextLvTrap].purchaseMater);

            spBtn[1].materValueText.text =
                string.Format("{0}",
                ShopManager.Instance.shopData.
                yellowData_Tower[nextLvTurret].purchaseMater);


            spBtn[2].materValueText.text =
                string.Format("{0}",
                ShopManager.Instance.shopData.
                yellowData_Tower[nextLvTower].purchaseMater);
